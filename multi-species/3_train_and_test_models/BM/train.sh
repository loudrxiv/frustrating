...
train_file=${ROOT}/3_train_and_test_models/BM/train.py
echo 'train file: ' ${train_file}

# (3) Now run a single training job 
echo 'running script'
python train.py "$tf" "$target" > "$LOG_TRAIN/BM_${tf}_${target}.log"